...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public void UpdateController(bool canMove, bool canRotate)
        {
            _hasAnimator = TryGetComponent(out _animator);

            JumpAndGravity();
            GroundedCheck();
            Move(canMove, canRotate);
        }
        ...
        private void Move(bool canMove, bool canRotate)
        {
            // set target speed based on move speed, sprint speed and if sprint is pressed
            var targetSpeed = _input.sprint ? SprintSpeed : MoveSpeed;
            targetSpeed = canMove ? targetSpeed : 0;
